...
template HitData pbss::parse_from_buffer_trusted<HitData>(const pbss::buffer&);
template HitData_tuple pbss::parse_from_buffer<HitData_tuple>(const pbss::buffer&);
template HitData_tuple pbss::parse_from_buffer_trusted<HitData_tuple>(const pbss::buffer&);
